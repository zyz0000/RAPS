...
from fewshot_re_kit.data_loader import get_loader, get_loader_unsupervised, get_loader2
from fewshot_re_kit.framework import FewShotREFramework
from fewshot_re_kit.sentence_encoder import BERTSentenceEncoder, BERTRelationEncoder
...
def main():
    ...
    parser.add_argument('--backend_model', type=str, default='bert', help='checkpoint name.')
    ...
    print("model: proto, encoder: bert")
    ...
    if not opt.only_test and (not opt.test_online):
        ...
        framework.train(model, prefix, batch_size, trainN, N, K, Q,
                ...
                na_rate=opt.na_rate, val_step=opt.val_step, 
        ...
        if ckpt is None:
            ...
            ckpt = 'none'
        framework.test(model, batch_size, N, K, Q, opt.test_iter, na_rate=opt.na_rate, ckpt=ckpt, test_output=opt.test_output)
